zen_python = """1.Beautiful is better than ugly.
...
#Вирішив для початку зберегти слова в змінних
bet = "better"
nev = "never"
is1 = "is"

#потім за допомогою методу рахуємо кількість слів в рядку
count1 = zen_python.count(bet)
count2 = zen_python.count(nev)
count3 = zen_python.count(is1)

#за допомогою ф-рядків виводимо результат
print(f"слово {bet} входить {count1} разів в рядок")
print(f"слово {nev} входить {count2} разів в рядок")
print(f"слово {is1} входить {count3} разів в рядок")

#за допомою методу упер виводимо текст з великих літер
upper_zen = zen_python.upper()
print(upper_zen)

#знайшов метод реплейс за допомогою якого вирішив задачу
new_zen = zen_python.replace("i", "&")
print(new_zen)