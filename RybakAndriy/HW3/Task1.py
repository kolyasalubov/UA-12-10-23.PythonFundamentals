...
print('Number of occurrences of the words better:', zen.count("better"))
print('Number of occurrences of the words never:', zen.count("never"))
print('Number of occurrences of the words is:', zen.count("is"))
print(zen.upper())
print(zen.replace('i', "&"))