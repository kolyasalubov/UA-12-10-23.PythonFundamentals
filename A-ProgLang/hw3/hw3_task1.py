...
38.Namespaces are one honking great idea -
- let's do more of those!Beautiful is better than ugly.
...
num_repet_better = zen_of_python.count("better")
num_repet_never = zen_of_python.count("never")
num_repet_is = zen_of_python.count("is")

print(f"\nNumber of repetitions of the word 'better'= {num_repet_better}"+
f"\nNumber of repetitions of the word 'never'= {num_repet_never}"+
f"\nNumber of repetitions of the word 'is'= {num_repet_is}")

all_text_uppercase = zen_of_python.upper()
print(f"\nAll text in uppercase:\n {all_text_uppercase}")

replace_i = zen_of_python.replace('i','&')
print(f"Replace all occurrences of the symbol 'i' with '&':\n {replace_i}")