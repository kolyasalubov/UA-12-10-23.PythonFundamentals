phylosophy = """1.Beautiful is better than ugly.
...
print('The number of the words better ',phylosophy.count('better'))
print('The number of the word never ',phylosophy.count('never'))
print('The number of the word is ', phylosophy.count('is'))
print()

print(phylosophy.upper())
print()
print(phylosophy.replace('i', '&'))
