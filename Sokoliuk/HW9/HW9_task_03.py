...
"""
This script allows you to obtain basic information about weather in the specific settlement

For using this app you need to register at https://openweathermap.org
obtain API key and enter your API key in API_KEY variable
"""
