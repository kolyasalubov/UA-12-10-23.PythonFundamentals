text = """1.Beautiful is better than ugly.
    ...
    """
quantity = text.split()
better_count = quantity.count('better')
never_count = quantity.count('never')
is_count = quantity.count('is')

print('There are', better_count, 'words "better" in this text')
print('There are', never_count, 'words "never" in this text')
print('There are', is_count, 'words "is" in this text')

replace_symbol = text.replace('i', '$')

up_text = replace_symbol.upper()
print(up_text)
